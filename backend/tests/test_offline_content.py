...
def _concepts() -> list[Concept]:
    return [
        Concept(id="target", name="Target", description="", difficulty=1, activity_ids='["target_activity"]'),
        Concept(id="other", name="Other", description="", difficulty=1, activity_ids='["other_activity"]'),
    ]
...
def test_offline_resolver_requires_relevant_educational_content() -> None:
    ...
    assert resolve_offline_availability(
